...
public class Taxi extends JFrame {
	...
	/* Values */
	private static final double NIGHTTAX = 1.1;		//Preiserh�hung bei Nachtfahrt
	private static final double TAXITAX = 7;		//Taxisteuern (in %)
	private static final double NORMALTAXI = 0.5;	//Km Preis f�r normales Taxi
	private static final double BIGTAXI = 1.0;		//Km Preis f�r gro�es Taxi
	private static final double STRECHLIMO = 2.0;	//Km Preis f�r Strechlimo
	private static final double BARPRICE = 15;		//Barpreis pro Person
	private static final double CHILDSEAT = 1;		//Aufpreis f�r Kindersitz
	private static final double STARTPARRA = 3.90;		//Aufpreis f�r Kindersitz
	private static final String MONEY = "€";		//W�hrung
	private static final String TYPE = "km";		//W�hrung
	...
	public Taxi() {
		...
		String comboBoxList[] = {"Normales Taxi", "Gro�raum Taxi", "Strechlimousine"};
